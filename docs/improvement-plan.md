...
| U4b | this commit | Chromium ignored break-after:avoid, stranding an entry header at the foot of Arabic A4 page 1 | each timeline entry prints whole | 6 PDFs (EN/FR/AR × A4/Letter) checked: no stranded headers; EN/FR 3 pages, AR 2–3 |
