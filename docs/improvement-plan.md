...
| U5 | this commit | "Start here" block on /projects/ | removed with its CSS, `startHere`/`startHereWhy` front matter (4 files) and i18n key (3 languages) | /projects/ EN/FR/AR × 390/1440 × light/dark render without it, no overflow |
