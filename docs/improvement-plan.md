...
| U3 | this commit | resume ended with "Back to Ibraverse" and a lone "Next: Search" card; prev/next were grey cards unlike the accent back link | section nav only inside a section; previous/next use the accent arrow link style with the title below | article (EN/AR), project 390, first-in-series; AR arrows mirror; resume has no section nav; gates pass |
