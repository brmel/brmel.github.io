...
This is where I learned the industry. I maintained core MIL modules like Calibration, Measurement, and Metrology. I also innovated by designing the **Advanced Geometric Matcher (AGM)**.
...
#### [Deep Learning & AI Specialization](https://www.coursera.org/account/accomplishments/certificate/8ZBT54UMC76C)
I learned the deep learning technology by completing the Coursera Deep Learning AI specialization, and developing machine learning algorithms like Random Forest and AdaBoost following industry standards into MIL.
{{< /timeline_item >}}

{{< timeline_item title="Master's Degree: [Polytechnique Montréal](https://www.polymtl.ca/)" date="2017 - 2019" >}}
...
I didn't just study theory; I built systems. I gained practical experience by developing real projects like synchronizing robot movement using the A* algorithm, developing real-time control systems for robots using QNX, and creating a vision system to guide a Fanuc robot.
{{< /timeline_item >}}

{{< timeline_item title="University (Bachelor's): [ENP Algiers](https://www.enp.edu.dz/en/)" date="2012 - 2017" >}}
