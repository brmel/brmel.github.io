  ...
  - period: "2024 — الآن"
    ...
    work:
      - title: "خوارزميات يبني عليها آخرون منتجاتهم"
        ...
        text: >-
          أنا أحد المهندسين المسؤولين عن خوارزميات المكتبة. وعملي لا يتوقف عند
          كتابة الكود: أتفق على السلوك مع فرق الواجهة والتوثيق والاختبار قبل
          الإصدار، وأدخل بنفسي في التطبيقات التي يعجز العملاء عن تشغيلها لأعرف
          السبب.
      - title: "فحص يجري داخل الكاميرا نفسها"
        ...
        text: >-
          نقلت مكتبة التصوير إلى داخل الكاميرا نفسها، ليجري الفحص على الجهاز بدل
          حاسوب موصول به. واقتضى ذلك أن أُدخل الخوارزميات في ذاكرة أقل بكثير وأن
          أراقب كل تخصيص.
  ...
  - period: "2022 — 2024"
    ...
    work:
      - title: "الهندسة التي تقوم عليها وحدات 2D"
        text: >-
          حللت ونفّذت وصحّحت ما تحت Model Finder وEdge Finder وMeasurement
          وMetrology وCalibration وBead من هندسة وجبر وتحسين غير خطي، ووسّعت
          الاختبارات التي تحميها. ونقلت Advanced Geometric Matcher من خوارزمية
          داخلية إلى واجهة برمجية عامة، صمّمتها مع الفريق.
      - title: "إدخال تعلّم الآلة في مكتبة هندسية"
        video: "CS4cs9xVecg"
        videoAlt: "ملاحظات من تخصص التعلم العميق"
        text: >-
          أدخلت تعلّم الآلة الكلاسيكي في وحدات كانت هندسية بحتة، وكتبت الواجهات
          الجديدة وأمثلة العملاء التي صدرت معها. وأشرفت على المتدربين.
  ...
  - period: "2019 — 2022"
    ...
    work:
      - title: "تعلّم الصنعة"
        ...
        text: >-
          أول وظيفة لي بعد الماجستير، على الوحدات التي تقيس: Calibration
          وMeasurement وMetrology. وهناك صمّمت Advanced Geometric Matcher،
          الخوارزمية التي صارت لاحقًا واجهة برمجية عامة.
      - title: "العمل داخل قاعدة كود C++ ضخمة"
        video: "sfLZ7v9gEnc"
        videoAlt: "العمل داخل قاعدة كود مكتبة Matrox Imaging"
        text: >-
          استبدلت حلّالات قديمة في وحدات الهندسة بمُحسِّنات غير خطية، منها
  ...
  - period: "2017 — 2019"
    ...
    work:
      ...
      - title: "أنظمة، لا مقررات فقط"
        ...
        text: >-
          أنهيت كل مقرر مهم بشيء كان عليه أن يعمل فعلًا: روبوت عليه أن يبلغ
          نقطته، ومتحكم عليه أن يفي بموعده، وكاميرا عليها أن تخبر الذراع بموضع
          القطعة.
